...
export const config = {
  ...
  deepResearchMaxAttempts: Number(process.env.DEEP_RESEARCH_MAX_ATTEMPTS || 4),
  deepResearchNoMatchRetries: Number(process.env.DEEP_RESEARCH_NO_MATCH_RETRIES || 2),
  deepResearchConfirmationChecksAfterFound: Number(process.env.DEEP_RESEARCH_CONFIRMATION_CHECKS_AFTER_FOUND || 1),
